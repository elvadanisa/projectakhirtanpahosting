        ...
        <div class="col-md-6">
            ...
            <form method="POST">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?php echo $data['kode_pelanggan'] ?>" readonly name="kode_pelanggan">
                </div>
                <div class="form-group">
          ...
          <?php 
              ...
              if (isset($_POST['simpan'])) {
                ...
                $sql = $koneksi->query(" update tb_pelanggan set nama='$nama', telepon='$telepon', alamat='$alamat' where kode_pelanggan='$kode' ");
                if ($sql) {
                  ?>
