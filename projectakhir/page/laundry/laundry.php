              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="?page=laundry&aksi=ubah&id=<?php echo $data['id_laundry']; ?>" class="btn btn-success"> <i class="fa fa-edit"></i>Ubah</a>
                    ...
                    <?php } ?>    
                      ...
                      <a target="blank"href="page/laundry/cetak.php?id=<?php echo $data['id_laundry']; ?>" class="btn btn-default"> <i class="fa fa-print"></i>Cetak</a>
