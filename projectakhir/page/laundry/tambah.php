<script>
  ...
  function sum() {
    ...
    var total = parseInt(jumlah_kiloan)*5000;
        ...
        <div class="col-md-6">
          ...
          <?php 
              ...
              if (isset($_POST['simpan'])) {
                ...
                $sql = $koneksi->query("insert into tb_laundry (id_pelanggan, kode_user, tanggal_diterima, tanggal_selesai, jumlah_kiloan, nominal, status, catatan)values('$pelanggan', '$id_user', '$tgl_terima', '$tgl_selesai', '$jml_kiloan', '$total', '$status', '$catatan')");
                if ($sql) {
                  ?>
